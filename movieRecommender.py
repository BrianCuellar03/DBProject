...
from tfidf_recommender import build_tfidf_matrix, get_similar_movies
    ...
    def get_database_connection(self):
        ...
        try:
            connection = mysql.connector.connect(
                ...
                user='bcuellar',                  # Replace with your MySQL username
                password='pour-importance-badly', # Replace with your MySQL password
                database='comp373',
                port=3306 
            )
            return connection
